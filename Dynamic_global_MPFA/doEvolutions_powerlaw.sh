...
nohup mpirun -n $1 -machinefile $2 run_5_1type_ga.sh Powerlaw_dynamic_K-means_r96_50by50.xml>>launch/${logfilename}_stdout.log 2>> launch/${logfilename}_stderr.log &
