...
#include <argos3/plugins/robots/generic/control_interface/ci_leds_actuator.h>//huisun1225
...
class BaseController : public argos::CCI_Controller {
  ...
  unsigned int GetCollisionTime();//qilu 09/26/2016
		...
		void Stop();
		void Move();
		void Move(bool isRobot_infected);//huisun1225
		bool Wait();
	...
	protected:
		...
		argos::CCI_LEDsActuator* m_pcLEDs;//huisun1225
