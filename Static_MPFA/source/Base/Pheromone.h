...
class Pheromone {
    ...
    public:
        ...
        Pheromone(argos::CVector2 newLocation, std::vector<argos::CVector2> newTrail, argos::Real newTime, argos::Real newDecayRate, size_t density,bool ifInfected);//huisun1225
