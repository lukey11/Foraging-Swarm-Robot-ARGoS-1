...
nohup mpirun -n $1 -machinefile $2 run_5_1type_ga.sh Cluster_K-means_static_r96_50by50.xml>>launch/${logfilename}_stdout.log 2>> launch/${logfilename}_stderr.log &
