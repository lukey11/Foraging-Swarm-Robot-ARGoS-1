...
def compute_overall_time_data(datas):
    ...
    #searchTime.append(np.mean(searchTimeList))
...
rect_CPFA_search = ax.bar(ind, CPFA_search_mean_per_seed,width=width, color='r', edgecolor='black', yerr=CPFA_search_std_per_seed, ecolor='k')
#rect_CPFA_travel = ax.bar(ind, CPFA_travel_mean_per_seed,width=width, bottom=CPFA_search_mean_per_seed, color='r', edgecolor='black', hatch="X", yerr=CPFA_travel_std_per_seed, ecolor='k')
rect_CPFA_travel = ax.bar(ind, CPFA_travel_mean_per_seed,width=width, bottom=(-1)*CPFA_travel_mean_per_seed,  color='r', edgecolor='black', hatch="X", yerr=CPFA_travel_std_per_seed, ecolor='k')


rect_MPFA_search = ax.bar(ind+width, MPFA_search_mean_per_seed,width=width, color='b', edgecolor='black', yerr=MPFA_search_std_per_seed, ecolor='k')
#rect_MPFA_travel = ax.bar(ind+width, MPFA_travel_mean_per_seed,width=width, bottom=MPFA_search_mean_per_seed, color='b', edgecolor='black', hatch="X", yerr=MPFA_travel_std_per_seed, ecolor='k')
rect_MPFA_travel = ax.bar(ind+width, MPFA_travel_mean_per_seed,width=width, bottom =(-1)*MPFA_travel_mean_per_seed, color='b', edgecolor='black', hatch="X", yerr=MPFA_travel_std_per_seed, ecolor='k')


rect_MPFTD_search = ax.bar(ind+2.0*width, MPFTD_search_mean_per_seed,width=width, color='g', edgecolor='black', yerr=MPFTD_search_std_per_seed, ecolor='k')
#rect_MPFTD_travel= ax.bar(ind+2*width, MPFTD_travel_mean_per_seed,width=width, bottom=MPFTD_search_mean_per_seed, color='g', edgecolor='black', hatch="X", yerr=MPFTD_travel_std_per_seed, ecolor='k')
rect_MPFTD_travel= ax.bar(ind+2.0*width, MPFTD_travel_mean_per_seed,width=width, bottom=(-1)*MPFTD_travel_mean_per_seed, color='g', edgecolor='black', hatch="X", yerr=MPFTD_travel_std_per_seed, ecolor='k')


rect_K_means_static_search = ax.bar(ind+3.0*width, k_means_static_search_mean_per_seed,width=width, color='m', edgecolor='black', yerr=k_means_static_search_std_per_seed, ecolor='k')
#rect_K_means_static_travel = ax.bar(ind+3*width, k_means_static_travel_mean_per_seed, width=width, bottom=k_means_static_search_mean_per_seed, color='m', edgecolor='black', hatch="X", yerr=k_means_static_travel_std_per_seed, ecolor='k')

rect_K_means_static_travel = ax.bar(ind+3.0*width, k_means_static_travel_mean_per_seed, width=width, bottom=(-1)*k_means_static_travel_mean_per_seed, color='m', edgecolor='black', hatch="X", yerr=k_means_static_travel_std_per_seed, ecolor='k')


rect_K_means_dynamic_search = ax.bar(ind+4.0*width, k_means_dynamic_search_mean_per_seed,width=width, color='c', edgecolor='black', yerr=k_means_dynamic_search_std_per_seed, ecolor='k')
#rect_K_means_dynamic_travel = ax.bar(ind+4*width, k_means_dynamic_travel_mean_per_seed, width=width, bottom=k_means_dynamic_search_mean_per_seed, color='c', edgecolor='black', hatch="X", yerr=k_means_dynamic_travel_std_per_seed, ecolor='k')
rect_K_means_dynamic_travel = ax.bar(ind+4.0*width, k_means_dynamic_travel_mean_per_seed, width=width, bottom = (-1)*k_means_dynamic_travel_mean_per_seed, color='c', edgecolor='black', hatch="X", yerr=k_means_dynamic_travel_std_per_seed, ecolor='k')
