...
autolabel_relate(rect_CPFA_travel, rect_CPFA_search)
autolabel_relate(rect_MPFA_travel, rect_MPFA_search)
autolabel_relate(rect_MPFTD_travel, rect_MPFTD_search)
autolabel_relate(rect_K_means_static_travel, rect_K_means_static_search)
autolabel_relate(rect_K_means_dynamic_travel, rect_K_means_dynamic_search)

savefig('3_stackPlot_total_search_travel_time')
plt.show()
